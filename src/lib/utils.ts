...
export const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    priceInr: 499,
    period: "month",
    tagline: "The ultimate Skill OS experience",
    features: [
      "Everything in Pro Plan",
      "Priority AI & Admin project reviews",
      "1-on-1 portfolio review feedback",
      "Exclusive Mastermind challenges & badges",
      "Direct Founder support & Discord role",
      "Completely ad-free experience",
    ],
  },
];
